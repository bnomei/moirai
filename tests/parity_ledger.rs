...
const PARITY_CLOSURES: &[ParityClosure] = &[
    ...
    ParityClosure { source_line: 388, source: "take_and_restore_entry_roundtrip", class: "adapt", owner: "Phase 3", moirai_proof: "tests/resources.rs::resource_scope_updates_value" },
    ...
    ParityClosure { source_line: 5114, source: "query_cached_reuses_plan", class: "adapt", owner: "Phase 5", moirai_proof: "tests/query_cache.rs::query_cache_cold_and_hot_hit" },
    ParityClosure { source_line: 5125, source: "query_cached_results_updates_on_add_remove", class: "preserve", owner: "Phase 5", moirai_proof: "tests/query_cache.rs::query_cache_updates_on_spawn" },
    ...
    ParityClosure { source_line: 5282, source: "query_cached_results_clear_rebuilds", class: "adapt", owner: "Phase 5", moirai_proof: "tests/query_result_cache.rs::result_cache_invalidate_and_rebuild" },
    ...
    ParityClosure { source_line: 5391, source: "query_cached_results_rejects_added_or_changed", class: "adapt", owner: "Phase 5", moirai_proof: "tests/query_cache.rs::query_result_cache_rejects_added_or_changed" },
    ...
    ParityClosure { source_line: 5739, source: "query_cached_params_updates_last_tick", class: "adapt", owner: "Phase 5", moirai_proof: "tests/query_cache.rs::membership_cache_stores_structural_members_for_added_queries" },
    ParityClosure { source_line: 5781, source: "query_cache_is_owner_scoped", class: "adapt", owner: "Phase 5", moirai_proof: "tests/query_cache.rs::query_cache_is_owner_scoped" },
    ...
    ParityClosure { source_line: 5974, source: "query_ids_filters_with_and_without", class: "preserve", owner: "Phase 5", moirai_proof: "tests/query.rs::dynamic_component_ids_apply_explicit_without_filters" },
    ParityClosure { source_line: 6001, source: "query_ids_excludes_inactive_when_enabled", class: "adapt", owner: "Phase 5", moirai_proof: "tests/query.rs::dynamic_component_ids_apply_explicit_without_filters" },
    ParityClosure { source_line: 6040, source: "query_ids_cached_last_tick_updates_on_exhaust", class: "preserve", owner: "Phase 5", moirai_proof: "tests/query.rs::entity_cursor_forks_and_commits_only_after_observed_exhaustion" },
    ParityClosure { source_line: 6070, source: "query_ids_cached_last_tick_skips_on_partial_iteration", class: "preserve", owner: "Phase 5", moirai_proof: "tests/query.rs::entity_cursor_forks_and_commits_only_after_observed_exhaustion" },
    ...
    ParityClosure { source_line: 6139, source: "query_ids_panics_on_unknown_component", class: "adapt", owner: "Phase 5", moirai_proof: "tests/query.rs::dynamic_component_ids_are_checked_with_or_windows" },
    ...
    ParityClosure { source_line: 6203, source: "resource_scope_updates_and_marks_changed", class: "adapt", owner: "Phase 3", moirai_proof: "tests/parity_gaps.rs::resource_scope_marks_changed" },
    ParityClosure { source_line: 6225, source: "resource_scope_returns_none_when_missing", class: "preserve", owner: "Phase 3", moirai_proof: "tests/resources.rs::resource_scope_reports_missing_without_mutation" },
